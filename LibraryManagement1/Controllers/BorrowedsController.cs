...
namespace LibraryManagement.Controllers
{
    public class BorrowedsController : Controller
    {
        ...
        public BorrowedsController(LibraryDbContext context)
        {
            _context = context;
        }
        ...
        {
            var libraryDbContext = _context.Borroweds.Include(b => b.Book).Include(b => b.Libra).Include(b => b.Student);
        ...
        public async Task<IActionResult> Create([Bind("BorrowId,StudentId,BookId,BorrowDate,DueDate,ReturnDate,LibraId,Status")] Borrowed borrowed)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BorrowId,StudentId,BookId,BorrowDate,DueDate,ReturnDate,LibraId,Status")] Borrowed borrowed)
        {
