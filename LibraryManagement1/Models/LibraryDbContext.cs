...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admins__AD0500A69BA7E21F");

            entity.HasIndex(e => e.Email, "UQ__Admins__AB6E616426F3A973").IsUnique();
        ...
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Authors__8E2731B95682E424");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Books__8BE5A10DF1750620");
        ...
        {
            entity.HasKey(e => e.BorrowId).HasName("PK__Borrowed__73982486E5FDFA3A");
        ...
        {
            entity.HasKey(e => e.CateId).HasName("PK__Categori__A88B4DE48601DEBF");
        ...
        {
            entity.HasKey(e => e.LibraId).HasName("PK__Libraria__1C1CFE100E1E5F8D");

            entity.HasIndex(e => e.Email, "UQ__Libraria__AB6E6164F08F59B9").IsUnique();
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__CD98462A586E4F29");

            entity.HasIndex(e => e.RoleName, "UQ__Roles__B1947861405A1C21").IsUnique();
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Students__4D11D63CFE9B1D9B");

            entity.HasIndex(e => e.Email, "UQ__Students__AB6E6164315A7E6D").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__CD3149CCB444F9DF");
