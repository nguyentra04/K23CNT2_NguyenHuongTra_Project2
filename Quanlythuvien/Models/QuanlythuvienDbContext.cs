...
public partial class QuanlythuvienDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            optionsBuilder.UseSqlServer("Name=ConnectionStrings:QuanlythuvienDB");
        }
    }
        ...
        modelBuilder.Entity<Book>(entity =>
        {
            ...
            entity.HasMany(d => d.Authors).WithMany(p => p.Books)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("BookId", "AuthorId").HasName("PK__BookAuth__0307D216E1C99C57");
            ...
            entity.HasMany(d => d.Cates).WithMany(p => p.Books)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("BookId", "CateId").HasName("PK__BookCate__D16D15D3AB546749");
